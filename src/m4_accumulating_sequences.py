...
def run_test_make_simple_string():
    ...
    expected = '4-5-6-7-8-'
    actual = make_simple_string(4, 8)
    print('Expected: ', expected)
    print('Actual', actual)

    print()
    expected = '4-'
    actual = make_simple_string(4, 4)
    print('Expected: ', expected)
    print('Actual', actual)
...
def run_test_make_less_simple_string():
    ...
    expected = '4-5-6-7-8'
    actual = make_less_simple_string(4, 8)
    print('Expected: ', expected)
    print('Actual', actual)

    print()
    expected = '4'
    actual = make_less_simple_string(4, 4)
    print('Expected: ', expected)
    print('Actual', actual)
